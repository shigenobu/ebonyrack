...
![](../image/section12/01.png)

##### 作業後

![](../image/section12/02.png)
...
- 「Import」ボタン
__初期状態でしか利用できません。__   
DDLを読み込ませることで、複数のテーブル、外部キー、シーケンスを作成します。
パーティション式は、整形されないので、別途整形してください。  
また、個別Importというのもあり、  
ワークスペースから1つまたは複数のテーブル、外部キー、シーケンスのDDLを読み込ませることは可能です。  
...
[(section13)Fileメニュー](section13.md)
