package com.walksocket.er.component.imp.foreignkey.root;
...
public class Form extends JPanel {
   ...
   * expression starting.
   */
  private static final String expressionStarting = "ALTER TABLE ... ADD CONSTRAINT ... FOREIGN KEY ... REFERENCES ...";
