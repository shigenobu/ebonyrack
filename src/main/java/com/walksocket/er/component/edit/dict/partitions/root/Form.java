...
public class Form extends JPanel {
  ...
  static {
    ...
    // u -> with dict
    // s -> show only
    columnNameWidthMaps.put("<html><s>Dict partition id</s></html>", 200);
    columnNameWidthMaps.put("<html><s>Partition name</s></html>", 200);
    columnNameWidthMaps.put("<html><s>Expression</s></html>", 600);
