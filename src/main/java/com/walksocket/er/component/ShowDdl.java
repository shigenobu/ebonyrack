...
import com.walksocket.er.component.show.ddl.Root;
 ...
 * ShowDdl.
 */
public class ShowDdl extends ErDialog {
  ...
  public ShowDdl(String ddl) {
    ...
    // init
    setTitle(String.format("%s - ddl", Const.TITLE));
