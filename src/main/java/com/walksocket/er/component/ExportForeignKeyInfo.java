...
import com.walksocket.er.component.export.foreignkeyinfo.Root;
...
/**
 * ExportForeignKeyInfo.
 */
public class ExportForeignKeyInfo extends ErDialog {
   ...
   */
  public ExportForeignKeyInfo(Main main, CfgProject cfgProject) {
    super();
    this.main = main;
    ...
    // init
    setTitle(String.format("%s - export foreign key info", Const.TITLE));
